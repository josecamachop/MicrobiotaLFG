...
% Script to analyze bacterial data  (after outliers removal)
%
...
indout = find(F(:,3)==13); % Deleting outlier found in first step
X(indout,:) = [];
F(indout,:) = [];
...
saveas(gcf,'Figures/FigManhattan_Qv_bac');
saveas(gcf,'Figures/FigManhattan_Qv_bac.jpg','jpg');
saveas(gcf,'Figures/FigManhattan_Qv_bac.png','png');
...
saveas(gcf,'Figures/FigManhattan_bac');
saveas(gcf,'Figures/FigManhattan_bac.jpg','jpg');
saveas(gcf,'Figures/FigManhattan_bac.png','png');
